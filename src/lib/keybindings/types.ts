...
export const ACTION_META: Record<HotkeyAction, { label: string; description: string }> = {
  ...
  "git.history": { label: "Toggle commit history", description: "Open or close commit history for the current project." },
  "git.fetch": { label: "Fetch", description: "Fetch remote refs for the current branch." },
  "git.pull": { label: "Pull (fast-forward)", description: "Fast-forward the current branch; fail instead of creating a merge commit." },
  "git.pullRebase": { label: "Pull with rebase", description: "Replay local commits on top of the remote branch." },
  "git.pullMerge": { label: "Pull with merge", description: "Merge the remote branch into the current branch." },
  "git.push": { label: "Push", description: "Push the current branch, setting its upstream when needed." },
  "git.createPullRequest": { label: "Create pull request", description: "Create or open the pull request for the current branch." },
  "project.ship": {
    label: "Commit & Push",
    description: "Stage all changes, create a commit with the configured commit CLI, then push it.",
  },
